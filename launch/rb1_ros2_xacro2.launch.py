...
def generate_launch_description():
    ...
    # This is to find the models inside the models folder in robot_description package
    ...
    robot_desc_path = os.path.join(
        get_package_share_directory("rb1_ros2_description"), "xacro", robot_desc_file
    )
